            ...
            <div class="d-flex flex-wrap align-items-stretch">
                ...
                <div class="col-lg-4 col-12 pt-5 col-md-6 order-lg-2 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        ...
                        <h4 class="text-dark mb-5 font-weight-normal"><?php echo e(__('Welcome to ')); ?><span class="font-weight-bold"><?php echo e(__('Quickfood')); ?></span>
                        </h4>
                        <?php if($errors->any()): ?>
...
<?php /**PATH /Users/mac/Sites/mealUp/resources/views/auth/login.blade.php ENDPATH**/ ?>