...
<section class="section">
    <div class="section-header">
        <h1>{{ $vendor->name }}&nbsp;{{ "Settlement" }}</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="{{ url('admin/home') }}">{{__('Dashboard')}}</a></div>
            <div class="breadcrumb-item active">
                <a href="{{ url('admin/vendor/'.$vendor->id) }}">{{ App\Models\Vendor::find($vendor->id)->name }}</a>
            </div>
            <div class="breadcrumb-item">{{__('vendor payment')}}</div>
        </div>
    </div>
    ...
    <div class="section-body">
        ...
        <h2 class="section-title">{{__("Vendor payment")}}</h2>
        <p class="section-lead">{{__('Vendor payment')}}</p>
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-9">
                ...
                <div class="card hide flutter_card">
                    ...
                    <div class="card-body">
                        <form action="{{ url('admin/fluterPayment') }}" method="post">
                            @csrf
                            <input type="hidden" name="vendor" value="{{ $vendor->id }}">
                            <input type="hidden" name="amount" value="{{ $amount }}">
                            <input type="hidden" name="duration" value="{{ $duration }}">
                ...
                <div class="card cod_card">
                    ...
                    <div class="card-body">
                        <input type="button" onclick="settlement()" value="{{__('Pay offline')}}" class="btn btn-primary">
                    </div>
                </div>
            </div>
        </div>
